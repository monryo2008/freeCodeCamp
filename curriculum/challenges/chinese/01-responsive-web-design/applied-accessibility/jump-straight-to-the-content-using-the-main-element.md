...
`main` 标签的语义化特性可以让辅助工具快速定位到页面的主体。 If you've ever seen a "Jump to Main Content" link at the top of a page, using a `main` tag automatically gives assistive devices that functionality.
